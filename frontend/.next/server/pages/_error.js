    ...
    (e.modules = {
      ...
      9131: (e, t, r) => {
        ...
        function s(e) {
          let t,
            { req: r, res: n, err: o } = e,
            a = n && n.statusCode ? n.statusCode : o ? o.statusCode : 404;
          if (r) {
            let e = (0, l.getRequestMeta)(r, 'initURL');
            e && (t = new URL(e).hostname);
          }
          return { statusCode: a, hostname: t };
        }
        let d = {
          error: {
            fontFamily:
        ...
        class c extends a.default.Component {
          render() {
            let { statusCode: e, withDarkMode: t = !0 } = this.props,
              r =
                this.props.title || u[e] || 'An unexpected error has occurred';
            return (0, o.jsxs)('div', {
              style: d.error,
              children: [
                (0, o.jsx)(i.default, {
